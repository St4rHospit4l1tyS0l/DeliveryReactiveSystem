...
{
    /// <summary>
    /// Interaction logic for AutoCompleteTextUc.xaml
    /// </summary>
    public partial class AutoCompleteTextUc
    {
        public AutoCompleteTextUc()
        {
            InitializeComponent();
            var autoComplete = new AutoCompleteTextUcBase(SearchTxtBox, ListData, PopupList, IsDone);
        }
