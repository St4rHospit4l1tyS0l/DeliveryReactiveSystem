...
namespace MahApps.Metro.Controls
{
    ...
    public static class ControlsHelper
    {
        ...
        public static readonly DependencyProperty FillIconProperty =
            DependencyProperty.RegisterAttached("FillIcon", typeof(Brush), typeof(ControlsHelper), new FrameworkPropertyMetadata(Brushes.Transparent, FrameworkPropertyMetadataOptions.AffectsRender | FrameworkPropertyMetadataOptions.Inherits));

        [AttachedPropertyBrowsableForType(typeof(MetroTabItem))]
        public static Brush GetFillIcon(UIElement element)
        {
            return (Brush)element.GetValue(FillIconProperty);
        }

        public static void SetFillIcon(UIElement element, Brush value)
        {
            element.SetValue(FillIconProperty, value);
        }



        public static readonly DependencyProperty IconResourceProperty =
            DependencyProperty.Register("IconResource", typeof(Geometry), typeof(ControlsHelper));
        
        [AttachedPropertyBrowsableForType(typeof(MetroTabItem))]
        public static Geometry GetIconResource(UIElement element)
        {
            return (Geometry)element.GetValue(IconResourceProperty);
        }

        public static void SetIconResource(UIElement element, Geometry value)
        {
            element.SetValue(IconResourceProperty, value);
        }

        public static readonly DependencyProperty VisualIconProperty =
            DependencyProperty.RegisterAttached("VisualIcon", typeof(Visual), typeof(ControlsHelper));

        [AttachedPropertyBrowsableForType(typeof(MetroTabItem))]
        public static Visual GetVisualIcon(UIElement element)
        {
            return (Visual)element.GetValue(VisualIconProperty);
        }

        public static void SetVisualIcon(UIElement element, Visual value)
        {
        ...
        public static readonly DependencyProperty HeightProperty =
            DependencyProperty.RegisterAttached("Height", typeof(double), typeof(ControlsHelper));
